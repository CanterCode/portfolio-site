...
const Footer = () => {
  return (
    <footer
      className="mt-auto py-4 px-6 w-full text-center text-text-muted text-sm border-t border-border bg-bg-overlay"
      role="contentinfo"
    >
      <div className="w-full max-w-7xl mx-auto">
        <small>
          &copy; {new Date().getFullYear()} Joshua Canterbury's Professional Portfolio. Like what
          you see?{' '}
          <Link
            to="/contact"
