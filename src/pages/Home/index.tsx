...
function Home() {
  return (
    <section
      className="text-text w-full flex-grow flex flex-col justify-center items-center py-6"
      ...
      <div className="w-full max-w-7xl px-6 md:px-12">
        <div className="flex flex-col md:flex-row items-center justify-center w-full gap-8 lg:gap-12">
          <div className="w-full lg:w-[55%] flex flex-col justify-center items-center md:items-start text-center md:text-left">
            <p className="text-lg md:text-xl font-normal text-text-muted mb-1">Howdy! My name is</p>
            <h1 id="home-heading" className="text-4xl md:text-5xl lg:text-6xl font-bold mb-2">
              Joshua Canterbury
            </h1>
            <p className="text-sm text-slate-500 tracking-wide mb-4">
              React, JavaScript, TypeScript, Node.js, AI Augmentation
            </p>
            <p className="mb-4 text-lg leading-relaxed">
              I'm a DFW based Software Engineer building clean, high-performance web apps. I spent a
              decade solving high-pressure problems in the service industry before moving into
              full-stack development. I turn complex ideas into simple, intuitive tools that
              actually work.
            </p>
